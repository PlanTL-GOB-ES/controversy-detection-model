...
#SBATCH -D .
#SBATCH --output=./slurm_logs/$2-controversy_title_balanced-%j.out
#SBATCH --error=./slurm_logs/$2-controversy_title_balanced-%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres gpu:4
...
DIR_NAME=$2_'controversy_title_balanced'_${BATCH_SIZE}_${WEIGHT_DECAY}_${LEARN_RATE}_$(date +"%m-%d-%y_%H-%M")
