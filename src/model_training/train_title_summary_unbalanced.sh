...
#SBATCH -D .
#SBATCH --output=./slurm_logs/bne-controversy_title_summary_unbalanced-%j.out
#SBATCH --error=./slurm_logs/bne-controversy_title_summary_unbalanced-%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres gpu:4
...
DIR_NAME='controversy_title_summary_unbalanced'_${BATCH_SIZE}_${WEIGHT_DECAY}_${LEARN_RATE}_$(date +"%m-%d-%y_%H-%M")
