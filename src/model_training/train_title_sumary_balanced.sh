...
#SBATCH -D .
#SBATCH --output=./slurm_logs/bne-controversy_title_sumary_balanced-%j.out
#SBATCH --error=./slurm_logs/bne-controversy_title_sumary_balanced-%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres gpu:4
...
DIR_NAME='controversy_title_sumary_balanced'_${BATCH_SIZE}_${WEIGHT_DECAY}_${LEARN_RATE}_$(date +"%m-%d-%y_%H-%M")
...
python ./run_glue.py --model_name_or_path $MODEL --seed $SEED \
					  --dataset_script_path ./controversy_title_sumary_balanced.py \
